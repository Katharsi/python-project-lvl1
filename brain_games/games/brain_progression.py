...
def get_progression(start_number, step_progression, length_progression):
    ...
    return list(range(start_number, start_number + length_progression * step_progression, step_progression))
...
def generate_number():
    ...
    func_progression = [str(num) for num in get_progression(start_number, step_progression, length_progression)]
